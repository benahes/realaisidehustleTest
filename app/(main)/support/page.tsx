export const metadata = {
    title: 'Support Hub | AI Intelligence',
    description: 'Architect Support Hub and Documentation',
};

const TICKETS = [
    {
        id: "#ARCH-9902",
        title: "GPU Cluster Latency in US-East-1",
        lastResponse: "14m ago",
        status: "Wait: Engineer",
        icon: "chat_bubble",
        colorBase: "primary",
    },
    {
        id: "#ARCH-9884",
        title: "Rate Limit Increase Request - Production",
        lastResponse: "2h ago",
        status: "Wait: User",
        icon: "pending",
        colorBase: "tertiary",
...
const DOCS = [
    {
        title: "Auto-Scaling V4 Guide",
        desc: "Latest optimization logic",
        icon: "description",
    },
    {
        title: "CLI Toolset Docs",
        desc: "Terminal command reference",
        icon: "terminal",
    },
    {
        title: "Encryption Protocol",
        desc: "Zero-trust setup",
        icon: "security",
    },
];
    ...
    return (
        <main className="max-w-container-max mx-auto px-3 sm:px-margin-edge pb-3 sm:pb-5 pt-[10px] sm:pt-[15px]">
            ...
            <section className="py-4 sm:py-8 flex flex-col items-center text-center">
                <h1 className="font-h1 text-xl sm:text-[32px] md:text-[40px] text-on-surface mb-2 sm:mb-3 tracking-tighter uppercase">ARCHITECT SUPPORT HUB</h1>
                <p className="text-xs sm:text-[14px] text-on-surface-variant max-w-2xl mb-4 sm:mb-8 leading-relaxed px-2 sm:px-0">Precision documentation and dedicated technical assistance for high-velocity AI system scaling.</p>
            ...
            <section className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-2 sm:gap-3 mb-4 sm:mb-8">
                ...
                <div className="md:col-span-2 md:row-span-2 glass-panel p-3 sm:p-6 hover:border-primary/50 transition-colors group cursor-pointer border border-outline-variant/20 rounded-lg">
                    ...
                    <p className="text-xs sm:text-[14px] text-on-surface-variant mb-4 sm:mb-8 leading-relaxed">Direct access to L3 systems engineers for complex infrastructure debugging and optimization.</p>
                    <button className="flex items-center gap-2 text-primary font-label-caps text-xs sm:text-[13px] uppercase group-hover:gap-4 transition-all">
                        Open Ticket <span className="material-symbols-outlined text-base sm:text-[18px]">arrow_forward</span>
                    </button>
                </div>
                ...
                <div className="md:col-span-1 glass-panel p-3 sm:p-5 hover:bg-surface-container-high transition-colors cursor-pointer border border-outline-variant/20 rounded-lg">
                    <div className="flex items-center justify-between mb-2 sm:mb-4">
                        <span className="material-symbols-outlined text-on-tertiary-fixed-variant text-lg sm:text-[24px]">api</span>
                ...
                <div className="md:col-span-1 glass-panel p-3 sm:p-5 hover:bg-surface-container-high transition-colors cursor-pointer border border-outline-variant/20 rounded-lg">
                    <div className="flex items-center justify-between mb-2 sm:mb-4">
                        <span className="material-symbols-outlined text-outline text-lg sm:text-[24px]">person</span>
                    </div>
                ...
                <div className="md:col-span-2 glass-panel p-3 sm:p-5 flex flex-row items-center justify-between hover:bg-surface-container-high transition-colors cursor-pointer border border-outline-variant/20 rounded-lg">
                    ...
                    <div className="text-right">
                        ...
                        <span className="font-h2 text-base sm:text-[18px] text-primary uppercase">Enterprise</span>
                    </div>
                </div>
            </section>

            {/* Active Tickets & Community */}
                ...
                <section className="lg:col-span-2">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                        <h2 className="font-h1 text-base sm:text-[22px] text-on-surface uppercase flex items-center gap-2 sm:gap-3">
                            Active Support Tickets
                            <span className="bg-primary-container text-white text-xs sm:text-[13px] w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center rounded-full">2</span>
                        </h2>
                ...
                <section className="lg:col-span-1">
                    <div className="relative overflow-hidden glass-panel rounded-lg p-4 sm:p-8 h-full flex flex-col justify-between border border-primary/30 group cursor-pointer">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xs sm:text-[14px] text-on-surface-variant mb-4 sm:mb-6 leading-relaxed">Join over 12,000 AI architects. Share playbooks, solve edge cases, and shape the platform roadmap.</p>
                        </div>
