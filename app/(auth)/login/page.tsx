...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setLoading(true)
        try {
            await signIn(identity, accessKey)
            router.push('/')
            router.refresh()
        } catch (err: any) {
            ...
            <section className="w-full lg:w-1/2 flex items-center justify-center p-margin-edge bg-surface">
                <div className="w-full max-w-[400px] flex flex-col gap-stack-loose pt-[10px]">
                    ...
                    <div className="space-y-stack-tight pt-[10px]">
                        <h2 className="font-h1 text-h1 text-on-surface">Initialize Session</h2>
                        <p className="font-body-sm text-body-sm text-on-surface-variant">Enter your intelligence credentials to access the Index.</p>
                    </div>
                    ...
                    <form className="space-y-stack-loose pt-[10px]" onSubmit={handleSubmit}>
                        <div className="space-y-stack-mid pt-[10px]">
                            {/* Identity Field */}
                            <div className="group">
                                <label className="font-label-caps text-label-caps uppercase text-on-surface-variant mb-unit block" htmlFor="identity">Intelligence Credential</label>
                                <div className="relative">
                                    <span className="material-symbols-outlined absolute left-0 bottom-stack-tight text-[18px] text-outline group-focus-within:text-primary transition-colors">fingerprint</span>
                                    <input
                            ...
                            <div className="group">
                                <div className="flex justify-between items-end">
                                    <label className="font-label-caps text-label-caps uppercase text-on-surface-variant mb-unit block" htmlFor="access-key">Access Key</label>
                                    <a className="font-body-xs text-body-xs text-primary/70 hover:text-primary mb-unit transition-colors" href="/forgot-password">Forgot Access Key?</a>
                                </div>
                                <div className="relative">
                        ...
                        <div className="pt-stack-mid space-y-stack-mid">
                            ...
                            <div className="relative flex items-center py-stack-tight">
                                ...
                                <span className="flex-shrink mx-4 font-label-caps text-label-caps text-outline-variant">Secure Authentication</span>
                                <div className="flex-grow border-t border-outline-variant/30"></div>
                            </div>
                            <button
                    ...
                    <div className="pt-stack-loose mt-auto">
                        <p className="font-body-sm text-body-sm text-on-surface-variant text-center">
                            New entity in the ecosystem?
                            <a className="text-primary font-semibold hover:underline" href="/register"> Request Node Creation</a>
                        </p>
                    </div>
                    {/* Legal/System Info */}
