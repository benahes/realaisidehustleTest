...
function simpleMarkdownToHtml(md: string): string {
  return md
    ...
    .replace(/!\[(.*?)\]\((.*?)\)/gim, "<img alt='$1' src='$2' class='w-full h-[35vh] sm:h-[70vh] rounded-xl border border-outline-variant/30 my-8 article-shadow object-cover bg-surface-container-lowest/50 block' />")
