...
function simpleMarkdownToHtml(md: string): string {
  return md
    ...
    .replace(/!\[(.*?)\]\((.*?)\)/gim, "<img alt='$1' src='$2' class='max-w-full w-auto h-auto max-h-[35vh] sm:max-h-[70vh] rounded-xl border border-outline-variant/30 my-8 article-shadow object-contain bg-surface-container-lowest/50 block mx-auto' />")
